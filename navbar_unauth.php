<div class="navbar navbar-static-top navbar-default hidden-xs">
	<div class="container"><!--container-->
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="/"><img class="logoh" src="graphics/h.svg"/></a>
		</div>
		<ul class="nav navbar-nav navbar-right">
			<li class="dropdown" id="add-active">
				...
				<ul class="dropdown-menu" role="menu">
					...
					<li><a href="http://ostock.online" class="dropdown-plus-title"><i class="fa fa-shopping-cart"></i> <strong>Shop</strong></a></li>
